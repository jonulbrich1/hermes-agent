...
from .util import redact_dict, sha256_file, utcnow
    ...
    def export(self, reason: str = 'manual') -> str:
        ...
        with tempfile.TemporaryDirectory(prefix='organic_review_') as td:
            ...
            manifest = {
                ...
                'core_note': 'Organic Processing Core state is included for audit. Search API keys are deliberately excluded/redacted.',
            ...
            table_names = ['tasks','task_events','user_claims','sources','claims','concepts','lexical_anchors','relations','growth_history','conversation','core_learning_events']
