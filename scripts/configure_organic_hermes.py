...
def runtime_python() -> Path:
    ...
    return next(
        ...
        candidates[0 if os.name == "nt" else 1],
    )
...
def organic_environment() -> dict[str, str]:
    ...
    return {
        ...
        "ORGANIC_RUNTIME_URL": os.environ.get(
        ...
        "ORGANIC_SEMANTIC_MODE": os.environ.get("ORGANIC_SEMANTIC_MODE", "heuristic"),
        "ORGANIC_HERMES_MODE": "1",
        "ORGANIC_SEMANTIC_INTERFACE": "1",
        "ORGANIC_HERMES_PLUGIN_ENABLED": "1",
        "ORGANIC_MODEL": os.environ.get("ORGANIC_MODEL", "inherit"),
